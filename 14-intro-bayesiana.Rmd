...
Bajo un modelo conjugado, la distribución posterior $p(\theta | \underline{X}_n)$ 
satisface 
$$p(\theta \, | \, \underline{X}_n) = \pi(\theta \, | \, \varphi_1),$$
donde $\varphi_1$ son los hiper-parámetros actualizados del modelo que se usó para
la previa.
