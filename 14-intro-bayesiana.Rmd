...
**Definición.** Decimos que la distribución conjunta de dos parámetros $\theta =
(\mu, \tau)$ sigue una distribución Normal--Gamma-Inversa, si podemos establecer
la siguiente estructura de dependencia condicional
