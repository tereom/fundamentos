...
Existen tres tipos de población de la cual podemos extraer una muestra de forma aleatoria  
  ...
  * Población *virtual.* Cuando tomamos observaciones del ambiente, por ejemplo tomar mediciones de la calidad de aire.  
  * Población *metafórica.* Cuando no hay grupo de individuos mas grande. Pero aún asi podemos pensar como si los datos provienen de un espacio imaginario de posibilidades.
```
