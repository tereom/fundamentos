...
Recuérdes que tenemos expresiones explícitas para la inicial $p(\theta)$ y la verosimilitud
...
introducir un parámetro de correlación entre las medidas de estatura y peso, pues
