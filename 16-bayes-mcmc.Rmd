...
sims_chico_tbl <- tibble(num_iter = 1:50000, theta = iterador_metro_chico(0.02, 50000))
...
sims_grande_tbl <- tibble(num_iter = 1:50000, theta = iterador_metro_grande(0.02, 50000))
...
Repite este proceso varias veces. Verifica que:
  ...
  - Si el tamaño de paso es muy chico, las estimaciones de la media están muy sesgadas
