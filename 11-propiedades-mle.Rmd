...
una función bien comportada, entonces la solución de encontrar el MLE en las
...
donde $\mathsf{se}$ denota el error estándar del MLE , $\mathsf{se} =
...
analítica la varianza asíntotica del MLE pues la aproximación 
...
Asimismo, el teorema de Normalidad asintótica nos permite establecer que el MLE es **asíntoticamente insesgado**. Es decir, 
