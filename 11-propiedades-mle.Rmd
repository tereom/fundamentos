...
En los pasos anteriores: 1) deriva el término faltante $\Psi (\theta^*);$
2) describe en tus propias palabras lo que significa $D( \theta^* \| \theta).$ Recuerda, que arriba la definimos para 
