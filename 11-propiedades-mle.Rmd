...
comportamiento controlado conforme tengamos más muestras disponibles. Sin
...
($\textsf{MLE}$, por sus siglas en inglés).

```{block, type = 'mathblock'}

**Definición.** El error cuadrático medio de un estimador $\tilde \theta_n$ se
calcula como
$$\textsf{MSE}[\tilde \theta_n] = \mathbb{E}[(\tilde \theta_n - \theta^*)].$$
