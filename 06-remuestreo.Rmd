...
g_2 <- ggplot(dist_boot %>% unnest(res_boot), aes(sample = estimate)) + geom_qq() + geom_qq_line()
g_1 + g_2
```
...
```{r}
set.seed(250)
casas_muestra <- sample_n(casas, 200)
...
## Bootstrap y estimadores complejos: muestreo {-}
...
```{r funcion_boot, cache = FALSE, message=FALSE}
