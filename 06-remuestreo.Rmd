...
intervalo_total %>% round(1)
```
y por construcción sabemos que es simétrico con respecto al valor estimado. Las
preguntas naturales en este contexto son:

- ¿Qué tan bueno puede ser un intervalo simétrico cuando la distribución
presenta asimetría?
- ¿Cómo afecta la asimetría la calidad del intervalo de confianza? 

Para responder estos puntos podemos calcular cuántas medias bootstrap están en las colas
de la distribución con respecto a las cotas del intervalo. Observamos que
esto nos arroja los siguientes porcentajes en términos de cobertura
