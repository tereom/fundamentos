...
muestra <- sample_n(poblacion_casas, 150, replace = TRUE)
```
...
grande de muestras con reemplazo de tamaño 150 **de la muestra**: el muestreo
debe ser análogo al que se tomó para nuestra muestra original.
...
```
A esta le llamamos la distribución de remuestreo de la mediana, que definimos más abajo.
