...
especificas. Como en toda esta sección, es necesario hacer
supuestos distribucionales para poder construir este tipo de pruebas.

Esta prueba se basa en la función de verosimilitud $L(\theta; x_1,\ldots, x_n)$
que examinamos en la sección de máxima verosimilitud. 
...
es $\hat{p} = 65/100 = 0.65$. Evaluamos la verosimilitud 

$$l(\hat{p}) = l(0.65) = 75\log(0.625) + 45\log(0.375) = -79.388$$
...
- Nótese que cuando este número es muy grande, esto implica que la hipótesis
nula es menos creíble, o menos consistente con los datos, pues la nula tiene mucho
menos verosimilitud de lo que los datos indican. Cuando este valor
...
```{block2, type='mathblock'}
Consideramos la hipótesis nula $\theta= \theta_0$. 
...
Para construir una prueba, como siempre, necesitamos una distribución de
