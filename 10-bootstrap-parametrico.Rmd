...
calculamos el estimador de máxima verosimilitud $\hat \theta_{\mathsf{MLE}}$ con los datos
observados. Enchufamos $\hat{f} = f(x;\hat \theta_{\mathsf{MLE}})$, y hacemos una gráfica
