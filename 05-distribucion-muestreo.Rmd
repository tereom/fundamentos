...
En esta sección usaremos notación acorde a la literatura estadística. Denotaremos por $n$ el tamaño de nuestras muestras y por $N$ el tamaño de la población. 
...
$$\sqrt{n} \, \frac{\bar{X}-\mu}{\sigma} \xrightarrow{}  N(0, 1)$$
