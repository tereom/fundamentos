...
variable con distribución normal $N(\mu, \sigma)$
sólo tenemos que saber los cuantiles de la distribución normal estándar $N(0,1)$ y escalarlos
...
De modo que si graficáramos los cuantiles de una distribución $N(\mu, \sigma)$ contra
los cuantiles de una distribución $N(0,1)$, estos cuantiles aparecen en una línea recta:
...
- Si la muestra tiene una distribución aproximadamente $N(\mu, \sigma)$, entonces
...
generando muestras normales $N(\bar{x}, s)$.
...
aproximadamente $N \left (15, \sqrt{\frac{30}{12}}\right)$. Entonces
...
## Más del Teorema central del límit {-}
