...
(también llamados **cuartiles**), así como el mínimo y máximo de los precios de
las casas:
...
interpretabilidad de nuestras comparaciones ~usando los principios 2 y 3~. Podemos
comenzar por agregar, por ejemplo, el nivel del marginación del municipio donde
