...
```{r, fig.asp = 0.7, fig.align = 'center', out.width = '80%', echo = FALSE}
...
```{r, warning=FALSE,  cache=TRUE, out.width = '95%', fig.align= 'center'}
library(ggrepel)
...
```{r,  cache=TRUE, out.width = '95%', fig.align= 'center'}
...
```{r, echo = FALSE, cache = TRUE, warning=FALSE, message=FALSE, out.width = '95%', fig.align= 'center'}
