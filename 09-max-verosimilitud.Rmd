# Estimación: máxima verosimilitud (parte 1)
...
modelos teóricos conocidos. El objetivo es entender **las ideas básicas** de estos procedimientos, y cómo evaluar sus resultados.
...
posible hacer más teoría útil que nos guíe. La desventaja es que es neceario que esos supuestos teóricos sean razonables.
...
pues la probabilidad de que cada observación sea 0 o 1 no depende de las observaciones restantes (la muestra se extrajo de manera independiente).érvese que para hacer esto usamos:
...
Cuando fijamos $n$ y $n_{err}$, esta función genera otra función, la log verosimilitud, que es la que queremos optimizar.
